    ...
    <>
      ...
      >
        ...
        >
          ...
          <a
            href="https://wa.me/5511999999999?text=Ol%C3%A1%20Renata!%20Gostaria%20de%20conversar%20sobre%20um%20projeto%20de%20interiores."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-12 py-5 text-sm tracking-widest uppercase transition-all duration-300"
            style={{
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#2F2A26";
              (e.currentTarget as HTMLAnchorElement).style.color = "#F6F2EC";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#F6F2EC";
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 text-xs">
              <a
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#B08A63"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#A8927D"; }}
              >
              ...
              <a
                href="mailto:contato@renatafidelis.com.br"
                className="transition-colors duration-300"
                style={{ color: "#A8927D", fontFamily: "var(--font-montserrat)" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#B08A63"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#A8927D"; }}
              >
                contato@renatafidelis.com.br
              </a>

              <div className="h-3 w-px hidden sm:block" style={{ backgroundColor: "#3D3530" }} />

              <span style={{ color: "#6B4F3D", fontFamily: "var(--font-montserrat)" }}>
                São Paulo, SP
              </span>
            </div>
          </div>
