      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {depoimentos.map((dep, i) => (
            <div
              key={i}
              className="p-8 flex flex-col justify-between transition-colors duration-300 group"
              style={{ backgroundColor: "#F6F2EC" }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLDivElement).style.backgroundColor = "#FAF8F4";
              }}
              onMouseLeave={(e) => {
        ...
        >
          ...
          <a
            ...
            onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#6B4F3D"; }}
          >
            Instagram
          </a>
          .
