      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            >
              {/* Placeholder para foto da Renata */}
              <div
          ...
          <div>
            ...
            >
              <p>
                Acredito que um espaço bem projetado tem o poder de transformar
                rotinas, melhorar relacionamentos e trazer leveza para o dia a dia.
              </p>
              <p>
            ...
            <blockquote
              className="mt-8 pl-5 font-light leading-snug"
              style={{
                fontFamily: "var(--font-cormorant)",
                fontSize: "1.4rem",
                color: "#2F2A26",
            ...
            >
              "Elegância, conforto e funcionalidade — no espaço certo para você."
            </blockquote>
          </div>
        </div>
      </div>
